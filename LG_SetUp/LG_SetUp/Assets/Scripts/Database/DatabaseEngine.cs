...
public static class DatabaseConnection {
    ...
    //used to set up the connection string used to connect to the database ----- to be changed to hashed creds for security --- middle man software not done
    static DatabaseConnection() {
        SqlConnectionStringBuilder builder = new SqlConnectionStringBuilder();
        builder.DataSource = "********.ddns.net";   // server or ip address ----- doesnt need to be ddns but it was used for security
